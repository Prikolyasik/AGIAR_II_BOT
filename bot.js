...
Пример: «Я подготовил фундамент. Чтобы получить детальную дорожную карту внедрения и спецификации нейросетевых модулей, свяжитесь с нашими специалистами: @AGIAR_NEWS».`;
...
bot.on('message', async (msg) => {
  ...
  try {
    ...
    await bot.sendMessage(chatId, 
      ...
      'Если проблема сохраняется — напишите нам: @AGIAR_NEWS'
    );
  }
});
